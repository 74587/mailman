...
func NewRouter(handler *APIHandler, openAIHandler *OpenAIHandler, wsHandler *WebSocketHandler, syncHandlers *SyncHandlers, pickupHandler *PickupHandler) http.Handler {
	...
	apiRouter.HandleFunc("/business-modules/{id}/scenarios", handler.ListBusinessScenariosHandler).Methods("GET")
	apiRouter.HandleFunc("/business-modules/{id}/scenarios", handler.CreateBusinessScenarioHandler).Methods("POST")
	apiRouter.HandleFunc("/business-modules/{id}/scenarios/{scenarioKey}", handler.GetBusinessScenarioHandler).Methods("GET")
	apiRouter.HandleFunc("/business-modules/{id}/scenarios/{scenarioKey}", handler.UpdateBusinessScenarioHandler).Methods("PUT")
	apiRouter.HandleFunc("/business-modules/{id}/scenarios/{scenarioKey}", handler.DeleteBusinessScenarioHandler).Methods("DELETE")
	...
	apiRouter.HandleFunc("/business-accounts/{id}/scenarios/{scenarioKey}/pickup", handler.PickupBusinessAccountScenarioHandler).Methods("POST")
